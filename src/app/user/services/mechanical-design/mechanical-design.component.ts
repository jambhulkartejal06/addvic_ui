...
@Component({
  ...
  templateUrl: './mechanical-design.component.html',
  styleUrls: ['./mechanical-design.component.css']
})
export class MechanicalDesignComponent implements OnInit {
  title='Mechanical Services | Mechanical Tools | Mechanical';
  ...
  this.metaTagService.updateTag(
    { name: 'description', content: 'We provide the best solutions using our prototype modelling and 3D printing tools and design including concept design, tooling design, CAD design, etc with customer satisfaction.'}
  );
}
