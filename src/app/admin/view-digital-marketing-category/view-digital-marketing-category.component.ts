...
@Component({
  selector: 'app-view-digital-marketing-category',
  templateUrl: './view-digital-marketing-category.component.html',
  styleUrls: ['./view-digital-marketing-category.component.css']
})
export class ViewDigitalMarketingCategoryComponent implements OnInit {

  ELEMENT_DATA :  CategoryDigitalMarketing[];
  
  displayedColumns: string [] = ['cat_id','category','action'];
  dataSource = new MatTableDataSource<CategoryDigitalMarketing>();
  ...
  public getAllCategory(){
    let res=this.categoryservice.getAlldigitalCategory();
  
    res.subscribe(category=>this.dataSource.data = category as CategoryDigitalMarketing[]);
  }
