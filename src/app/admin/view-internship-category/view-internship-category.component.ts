...
@Component({
  selector: 'app-view-internship-category',
  templateUrl: './view-internship-category.component.html',
  styleUrls: ['./view-internship-category.component.css']
})
export class ViewInternshipCategoryComponent implements OnInit {

  ELEMENT_DATA : CategoryInternship[];
  
  displayedColumns: string [] = ['cat_id','category','action'];
  dataSource = new MatTableDataSource<CategoryInternship>();
  ...
  public getAllCategory(){
    ...
    res.subscribe(category=>this.dataSource.data = category as CategoryInternship[]);
  }
